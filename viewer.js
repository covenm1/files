...
var DL_ENBL = dlenbl;
var DL_FILENAME = downloadFileName;
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '../../../js/pdfviewer/pdf.worker.js';
...
var DownloadManager = (function DownloadManagerClosure() {
  ...
  function download(blobUrl, filename) {
    if(DL_ENBL) {
        ...
        alert('This function is not availabe'); //added JZ for notafina
    }
  }
  ...
  PDFDocumentProperties.prototype = {
    ...
    _getProperties: function PDFDocumentProperties_getProperties() {
      ...
      this.pdfDocument.getMetadata().then(function(data) {
        var content = {
          'fileName': getPDFFileNameFromURL(DL_FILENAME),
...
var PDFViewerApplication = {
  ...
  download: function pdfViewDownload() {
    ...
    var filename = getPDFFileNameFromURL(DL_FILENAME);
  ...
  error: function pdfViewError(message, moreInfo) {
    ...
    // hide custom loader if an error occured
    document.getElementById('custom-pdf-loader').style.display = "none";
  },
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    //JZ added
    window.alert('NO PRINTING ALLOWED');
    this.printing = false;
    return;
...
function webViewerInitialized() {
  ...
  //  SecondaryToolbar.printClick.bind(SecondaryToolbar));
    ...
    if(DL_ENBL){
        ...
        document.getElementById('secondaryDownload').addEventListener(
            'click',
            SecondaryToolbar.downloadClick.bind(SecondaryToolbar)
        );
    }
